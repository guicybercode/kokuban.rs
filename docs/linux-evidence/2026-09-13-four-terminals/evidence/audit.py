...
def main():
    ...
    require('kokuban v0.2.0 (/source)' in (artifact/'cargo-tree.txt').read_text(), 'source cargo tree')
    ...
    require(rust_results == [('729', '0', '1'), ('0', '0', '0'), ('248', '0', '0')], 'fixed source test totals')
    ...
    audit = {'schema': 1, 'date': '2026-09-13', 'run': {'id': RUN, 'url': run['url'],
