...
BASE=Path('/private/tmp/kokuban-perf-20260913/root-evidence/run-34749172188')
...
HARNESS='ef8f63f1f5f3e9012d8b9f33b3183742059be47a'
...
(BASE/'independent-primary-dsr-audit.json').write_text(json.dumps(output,indent=2)+'\n')
...
print('PASS',BASE/'independent-primary-dsr-audit.json')
