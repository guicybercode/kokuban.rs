...
def summarize(report: dict, args) -> None:
    ...
    report["comparability"] = {"geometry_and_history_checks_passed": not reasons,
                               ...
                               "rendering_limitations": [
                                   ...
                                   "Kokuban currently does not attach combining marks to the preceding grid cell; following text can overwrite them",
                                   "Kokuban currently omits glyphs absent from the selected font; no fallback font is used",
                               ],
                               "ranking": None,
